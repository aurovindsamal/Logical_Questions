...
/**
 * 
 * @author aurovind.samal Given a singly linked list L: L0→L1→ ... →Ln-1→Ln,
 *         reorder it to: L0→Ln→L1→Ln-1→L2→Ln-2→...
 * 
 *         For example, given {1,2,3,4}, reorder it to {1,4,2,3}. You must do
 *         this in-place without altering the nodes' values.
 * 
 *         Break list in the middle to two lists (use fast & slow pointers)
 *         Reverse the order of the second list Merge two list back together
 */
