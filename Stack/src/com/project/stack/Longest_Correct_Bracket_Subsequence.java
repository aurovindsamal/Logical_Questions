...
public class Longest_Correct_Bracket_Subsequence {
	...
	/*
	 * BOP[] stands for "Balanced open parentheses" BCP[] stands for
	 * "Balanced close parentheses"
	 * 
	 */

//Function for precomputation
	static void constructBlanceArray(int BOP[], int BCP[], String str, int n) {
...
//Driver code
	public static void main(String[] args) {
		...
		System.out.print("Maximum Length Correct " + "Bracket Subsequence between " + startIndex + " and " + endIndex
