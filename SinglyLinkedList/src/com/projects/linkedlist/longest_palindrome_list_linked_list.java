...
/**
 * Given a linked list, find length of the longest palindrome list that exist in
 * that linked list.
 * 
 * Examples:
 * 
 * Input : List = 2->3->7->3->2->12->24 Output : 5 The longest palindrome list
 * is 2->3->7->3->2
 * 
...
public class longest_palindrome_list_linked_list {
