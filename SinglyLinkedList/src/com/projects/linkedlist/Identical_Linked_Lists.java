...
public class Identical_Linked_Lists
{
	...
	otherwise false */
	boolean areIdentical(Identical_Linked_Lists listb)
	{
	...
	{
		Identical_Linked_Lists llist1 = new Identical_Linked_Lists();
		Identical_Linked_Lists llist2 = new Identical_Linked_Lists();
